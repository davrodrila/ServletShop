    ...
    <div class="main_right">
      <div class="clr"></div>
        ...
        <h1>Panel de administraci&oacute;n.</h1>
            <table>
                <tr><td>Juegos</td><td><a href="mantenimientojuegos.jsp" >Ir</a></td></tr>
                <tr><td>Plataformas</td><td><a href="mantenimientoplataforma.jsp" >Ir</a></td></tr>
                <tr><td>G&eacute;neros</td><td><a href="mantenimientogenero.jsp" >Ir</a></td></tr>
                <tr><td>Usuarios</td><td><a href="mantenimientoUsuario.jsp" >Ir</a></td></tr>
                <tr><td>Pedidos</td><td><a href="mantenimientopedidos.jsp" >Ir</a></td></tr>
            </table>
        <% } else {
            %>

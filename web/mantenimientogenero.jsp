...
%>
    ...
    <div class="main_right">
      <div class="clr"></div>
              <h2>Mantenimiento de Generos</h2>
    <body>
                <%
            if (ds!=null)
            {
        ...
        <table>
            ...
            <a href="altagenero.jsp">A&ntilde;adir G&eacute;nero</a>
            <tr>
                <th>ID</th>
                <th>Descripcion</th>
                <th>Miniatura</th>
            ...
            %>
                ...
                <td><%=g.getImagen() %></td>
                <td>
                    <form method='post' action='modificargenero.jsp'>
                        <input type='hidden' name='id' value='<%=g.getIDGenero()%>' />
                        <input type='submit' value='Modificar' />
                        </form>
                </td>
                <td>
                    <form method='post' action='bajaGenero' id='<%="BorrarGen"+j%>'>
                        <input type='hidden' name="id" value='<%=g.getIDGenero() %>' />
                        <input type='button' onClick='confirmar("BorrarGen<%=j%>","el genero <%=g.getNombre()%>")' value='Borrar' />
                    </form>
                </td>
                </tr>
            <%

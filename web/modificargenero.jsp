...
%>
    ...
    <table>
        <%
            ...
            {
                %>
	<form method='post' action='accionModificarGenero'>
            <%
                if (util.isNumeric(request.getParameter("id")))
                {
                    int id = Integer.parseInt(request.getParameter("id"));
                    Genero g = Persistencia.obtenerGenero(id);
            %>
                <tr>
                    <td><input type="hidden" name="id" value="<%=g.getIDGenero()%>"/></td>
                </tr>
		<tr>
			<td> Descripcion: </td>
			<td><input type='text' name='nombre' value="<%=g.getNombre()%>"/> </td>
		</tr>
		<tr>
			<td> Miniatura: </td>
			<td><input type='text' name='imagen' value="<%=g.getImagen()%>"/></td>
		</tr>
                <tr>
                    <td><input type='submit' value='A&ntilde;dir'></td>
		</tr>

...
%>
    ...
    if (ds==null)
                    {
        %>
        <h2>Accede al sistema para ver el catálogo</h2>
        <%
        } else {
%>
        ...
        <table>
            ...
            %>
                        <tr>
                                ...
                                <td><img src='<%=j.getImagen()%>' /></td>
                                <%
                                if (comprar){
                                    compra+=k;
                                %>
                                <td>
                                    <form action="ficha.jsp" method="POST" name="<%=compra%>">
                                        <input type="hidden" name="id" value="<%=j.getIDJuego()%>" />
                                        <a href="#" onclick="document.forms.<%=compra%>.submit()">Ver detalles</a>
                                    </form>
                                </td>
                                <%
                                k++;

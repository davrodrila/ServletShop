...
%>
    ...
    <div class="main_right">
      <div class="clr"></div>
            <h2>Alta de Direcciones</h2>
            <form action='altaDireccion' method='POST'>
        <table>
            <tr><td><input type='hidden' name='idusu' value='<%=request.getParameter("id")%>' /></td></tr>
            <tr><td>Alias: </td><td><input type='text' name='nombre' />
            <tr><td>Linea 1: </td><td><input type='text' name='dir1' />
            <tr><td>Linea 2: </td><td><input type='text' name='dir2' />
            <tr><td>Localidad: </td><td><input type='text' name='loc' />
            <tr><td>Provincia: </td><td><input type='text' name='provi' />
            <tr><td>C&oacute;digo postal: </td><td><input type='text' name='cp' />
            <tr><td><input type='submit' value='Nuevo' /></td></tr>
            </form>
        </table>
</div>
    <div class="clr"></div>

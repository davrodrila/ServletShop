...
public class vaciarcesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DatosSesion ds = (DatosSesion) request.getAttribute("ds");
                    RequestDispatcher rd;
            rd = getServletContext().getRequestDispatcher("/cabecera.jsp");
            rd.include(request, response);
            out.println("<h2 style='padding:30px 0 5px 5px;'>Cesta Vaciada</h2><br />");
        if (ds != null) {

            out.println("<a href='cesta.jsp'>Volver</a>");
            if (ds.getCesta() != null) {
                List<itemCesta> ic = ds.getCesta();
                ic.clear();
                ds.setCesta(ic);
            }
        }

 ...
 * @author NOCTURO
 */
public class bajaPlataforma extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<h2 style='padding:30px 0 5px 5px;'>Baja de plataformas</h2><br />");
        if (util.isNumeric(request.getParameter("id")))
        {
            int id = Integer.parseInt(request.getParameter("id"));
            Presentacion.cabeceraHTML(response.getWriter(),"Baja de Plataformas");

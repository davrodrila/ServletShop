...
%>
    ...
    <div class="main_right">
      <div class="clr"></div>
      <h2 style="padding:30px 0 5px 5px;">Inicio</h2><br />
      <p>
          Bienvenido a esta tienda de videojuegos. Por favor, regístrate o, si ya eres usuario, accede al sistema para poder comprar en nuestro catalogo.
      </p>
    </div>
    <div class="clr"></div>
</div>

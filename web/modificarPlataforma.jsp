  ...
  <h2>&nbsp;</h2>
    ...
    <div class="main_right">
      <div class="clr"></div>
            ...
            {
                %>
        <table><form method='post' action='accionModificarPlataforma'>
                <%
                    ...
                    if (util.isNumeric(request.getParameter("id")))
                     {
                        ...
                        Plataforma p = Persistencia.obtenerPlataforma(id);
                        if (p!=null)
                            {
                %>
                <tr>
                    <td>
                    <input type='hidden' name='id' value='<%=p.getIDPlataforma()%>'></td></tr>
                    <tr><td> Nombre: </td><td><input type='text' name='desc' value='<%=p.getDescripcion()%>'></td></tr>
                <tr><td> Ruta de la imagen del juego. </td><td><input type='text' name='imagen' value='<%=p.getImagen()%>'></td><td><img src='<%=p.getImagen()%>'></td></tr>

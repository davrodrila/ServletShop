...
%>
 ...
 <h2>&nbsp;</h2>
    ...
    <body>
        ...
        <table>
            <tr><th>ID</th><th>Usuario</th><th>Direccion</th><th>Fecha</th></tr>
                <%
                            List<Pedido> pl = Persistencia.listaPedidos();
                            if (pl != null) {
                                Iterator<Pedido> i = pl.iterator();
                                Pedido p;
                                int k = 0;
                                while (i.hasNext()) {
                                    p = i.next();
            ...
            <tr>
                ...
                <td><%=p.getIDDireccion()%></td>
                <td><%=p.getFechaPedido()%></td>
                <td><form method="post" action="verpedido.jsp"><input type="hidden" name="id" value="<%=p.getIDPedido()%>" /><input type="submit" value="Ver lineas" /></form></td>
            </tr>
            <%
                    k++;
                                }
